...
<div class="col-md-8">
   <article class="widget widget__form">
      ...
      <div class="widget__content">
         ...
         <?=$this->Form->text("idempr", ["size" => 10, "maxlength" => 10, "class" => "stacked-input upper", "id" => "idempr", "placeholder" => "idempr"]);?>
         <label for="nombre" class="stacked-label"><i class="pe-7s-hammer" ></i></label>
         <?=$this->Form->text("nombre", ["size" => 100, "maxlength" => 100, "class" => "stacked-input upper", "id" => "nombre", "placeholder" => "nombre"]);?>
