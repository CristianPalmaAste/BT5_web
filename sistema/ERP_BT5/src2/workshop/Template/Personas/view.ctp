...
<div class="col-md-8">
   <article class="widget widget__form">
      ...
      <div class="widget__content">
         ...
         <?=$this->Form->text("idesci", ["size" => 10, "maxlength" => 10, "class" => "stacked-input", "id" => "idesci", "readonly" => true]);?>
         <label for="idsexo" class="stacked-label"><i class="pe-7s-hammer" ></i></label>
         <?=$this->Form->text("idsexo", ["size" => 10, "maxlength" => 10, "class" => "stacked-input", "id" => "idsexo", "readonly" => true]);?>
