...
class TiposClientesController extends AppController
{
    public function index()
    {
        ...
        $gre = $this->TiposClientes->newEntity();
        
        if ($this->request->is('post')) {
           $gre = $this->TiposClientes->patchEntity($gre, $this->request->data);
        }             
...
if ($gre->descripcion!=null) $cond["descripcion like"] = $gre->descripcion."%";
        ...
        $TiposClientes = $this->paginate($this->TiposClientes->find('all')->where($cond));

        $this->set("registros", $TiposClientes); 
    }
    ...
    public function add() {
	   ...
	   if ($this->request->is('post')) {
	     ...
	     if ($this->TiposClientes->save($gre)) {
    ...
    public function edit($id=null) {
       $session = $this->request->session();
       $gre = $this->TiposClientes->get($id);

       $this->set("errors", []);

	   if ($this->request->is(['post', 'put'])) {
	      $this->TiposClientes->patchEntity($gre, $this->request->data);
    ...
    public function delete($id)
    {
       ...
       $registro = $this->TiposClientes->get($id);

       //$registro->idusuaborraregistro = $session->read("idusua");
       //$registro->fechaborraregistro  = date('Y-m-d H:i:s');	

       $this->TiposClientes->save($registro);
...
;
       ...
       $rows = $this->TiposClientes->find('all'); 
