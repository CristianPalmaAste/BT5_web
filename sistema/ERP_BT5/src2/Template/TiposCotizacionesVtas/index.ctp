<?=$this->Form->create($gre, ["class" => "form-horizontal", 'url' => '/TiposCotizacionesVtas/index', 'novalidate' => true]);?>
<?php echo $this->BForm->formHeader( 'Tipos de Cotizaciones de Ventas' ); ?>

<div class="col-md-4 text-center btn-vars__showcase">
   <div class="btn-group block">
      <a href="<?=$this->request->webroot?>TiposCotizacionesVtas/add" title='Nuevo registro' class="btn dark"><i class="pe-7s-plus"></i>&nbsp; Nuevo</a>
   </div>
</div>
<?php echo $this->BForm->initForm( 'Tipos de Cotizaciones de Ventas',array(
