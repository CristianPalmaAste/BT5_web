...
<?= $this->Form->create($gre, ["id" => "frm", "method" => "post"]) ?> 
     ...
     <div class="widget__content">
		 ...
		 <td>
		 <input type="text" id="idtidv" size="8" value="<?=$tipos_doctos_ventas[$gre->idtidv]?>" style="color:black;" readonly/>
		 &nbsp;
		 ...
		 &nbsp;
         <?=$this->Form->text("fechaventa", ["size" => 10, "maxlength" => 10, "class" => "stacked-input upper", "id" => "fechaventa", "style" => "color:black;", "required" => true, "value" => $this->Time->format($gre->fechaventa,'d/MM/Y'), "readonly" => true, "readonly" => true]);?>
		 ...
		 <td>
         <?=$this->Form->text("descripcionventa", ["size" => 80, "maxlength" => 250, "class" => "stacked-input upper", "id" => "descripcionventa", "style" => "color:black;", "readonly" => true]);?>
		 </td>
		 </tr>
		 <tr><td>
		 ...
		 <td>
         <?=$this->Form->text("exento", ["size" => 10, "maxlength" => 12, "class" => "stacked-input upper", "id" => "exento0", "style" => "color:black;text-align:right;", "readonly" => true]);?>
		 </td>
		 </tr>
		 <tr><td>
		 ...
		 <tr><td>
         <label for="impuestosobligats0" >Impto.Obligat.</i></label></td>
		 <td>
		 ...
		 <tr><td>
         <label for="impuestosespecifs0" >Impto.Específico</i></label></td>
		 <td>
