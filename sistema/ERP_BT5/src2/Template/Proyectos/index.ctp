<?=$this->Form->create($gre, ["class" => "form-horizontal", 'url' => '/Proyectos/index', 'novalidate' => true]);?>
<?php echo $this->BForm->formHeader( 'Mantención de Proyectos' ); ?>

<div class="col-md-4 text-center btn-vars__showcase">
   <div class="btn-group block">
      <a href="<?=$this->request->webroot?>Proyectos/add" title='Nuevo registro' class="btn dark"><i class="pe-7s-plus"></i>&nbsp; Nuevo</a>
   </div>
</div>
<?php echo $this->BForm->initForm( 'Mantención de Proyectos',array(
...
?>
<!--<tr>
<td><?=$this->Form->text("nombre", ["size" => 20, "maxlength" => 45, "class" => "stacked-input upper", "id" => "nombre"]);?></td>
