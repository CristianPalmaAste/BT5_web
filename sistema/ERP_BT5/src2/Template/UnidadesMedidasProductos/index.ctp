<?=$this->Form->create($gre, ["class" => "form-horizontal", 'url' => '/UnidadesMedidasProductos/index', 'novalidate' => true]);?>
<?php echo $this->BForm->formHeader( 'Unidades de Medidas de los Productos' ); ?>

<div class="col-md-4 text-center btn-vars__showcase">
   <div class="btn-group block">
      <a href="<?=$this->request->webroot?>UnidadesMedidasProductos/add" title='Nuevo registro' class="btn dark"><i class="pe-7s-plus"></i>&nbsp; Nuevo</a>
   </div>
</div>
<?php echo $this->BForm->initForm( 'Unidades de Medidas de los Productos',array(
