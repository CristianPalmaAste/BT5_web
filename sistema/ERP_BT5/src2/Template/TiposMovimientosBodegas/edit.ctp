...
<div class="col-md-8">
   <article class="widget widget__form">
      ...
      <div class="widget__content">
         <label for="descripcion" class="stacked-label"><i da-toggatle="tooltip" title="Descripción" class="pe-7s-note" ></i></label>
         <?=$this->Form->text("descripcion", ["size" => 10, "maxlength" => 100, "class" => "stacked-input upper", "id" => "descripcion", 'placeholder' => 'Descripción*']);?>
         <label for="signo" class="stacked-label"><i da-toggatle="tooltip" title="Signo" class="pe-7s-menu" ></i></label>
