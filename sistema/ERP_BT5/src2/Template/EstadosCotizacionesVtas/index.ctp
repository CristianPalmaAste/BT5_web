<?=$this->Form->create($gre, ["class" => "form-horizontal", 'url' => '/EstadosCotizacionesVtas/index', 'novalidate' => true]);?>
<?php echo $this->BForm->formHeader( 'Estados de Cotizaciones de Ventas' ); ?>

<div class="col-md-4 text-center btn-vars__showcase">
   <div class="btn-group block">
      <a href="<?=$this->request->webroot?>EstadosCotizacionesVtas/add" title='Nuevo registro' class="btn dark"><i class="pe-7s-plus"></i>&nbsp; Nuevo</a>
   </div>
</div>
<?php echo $this->BForm->initForm( 'Estados de Cotizaciones de Ventas',array(
