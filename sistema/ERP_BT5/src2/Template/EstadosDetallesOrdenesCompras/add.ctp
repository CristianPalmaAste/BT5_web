   ...
   <article class="widget widget__form">
      <header class="widget__header">
         <div class="widget__title">
            <i class="pe-7s-file"></i><h3>Estados Detalles Ordenes de Compras</h3>
         </div>
      </header>
...
<a href="<?=$this->request->webroot?>EstadosDetallesOrdenesCompras/index" class="btn dark inverse">Volver</a>
</div>
</div>
