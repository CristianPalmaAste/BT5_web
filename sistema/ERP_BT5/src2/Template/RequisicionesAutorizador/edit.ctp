...
<tr><td><label for='idereq' >Estado Requisición*</label></td><td><?=$this->Form->select("idereq", $estados_requisiciones, ["class" => "stacked-input", "id" => "idereq", 'placeholder' => 'Estado Requisición', 'style' => 'color:black;']);?>
</td></tr>
<tr><td><label for='idereq' >Razón Rechazo</label></td><td><?=$this->Form->text("razonrechazo", ["class" => "stacked-input upper", "id" => "razonrechazo", 'style' => 'color:black;', 'size' => 65]);?>
</td></tr>
...
//	  if (!isNumber(this.value)) this.value="";
 //  }
   ...
   document.getElementById("frm").onsubmit=function() {
	  ...
	  idereq = document.getElementById("idereq");
	  razonrechazo = document.getElementById("razonrechazo");
	  
	  if (idereq.value==3 && razonrechazo.value=="") {
		 alert("¡Debe ingresar razón del rechazo!");
		 razonrechazo.focus();
		 razonrechazo.select();
