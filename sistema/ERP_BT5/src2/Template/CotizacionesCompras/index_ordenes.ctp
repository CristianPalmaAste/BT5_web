...
<?php echo $this->BForm->formHeader( 'Cotización desde Órdenes de Compras' ); ?>
...
<?php echo $this->BForm->initForm( 'Cotización desde Órdenes de Compras',array(        
...
<?php foreach($registros as $g):?>
      ...
      <tr>
         ...
         <td align='center'>
            ...
            <?= $this->Html->link('<i class="pe-7s-note"></i>', ['action' => 'addCotOc', $g->id],array('escape' => false, 'title' => 'Nueva Cotización')) ?>
