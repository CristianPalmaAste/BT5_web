...
<?php echo $this->BForm->formHeader( 'Nueva Cotización desde Requisiciones' ); ?>

<?php echo $this->BForm->initForm( 'Nueva Cotización desde Requisiciones',array(        
...
<?php foreach($registros as $g):?>
      ...
      <tr>
         ...
         <td align='center'>
         <?= $this->Html->link('<i class="pe-7s-note"></i>', ['action' => 'addCotRq', $g->id],array('escape' => false, 'title' => 'Nueva Cotización')) ?>			
         </td>
     </tr>
     <tr class='spacer'></tr>
<?php endforeach; ?>
