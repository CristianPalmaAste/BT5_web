...
<?php echo $this->BForm->formHeader( 'Órdenes de Compras' ); ?>
...
<?php echo $this->BForm->initForm( 'Órdenes de Compras',array(        
...
<?php foreach($registros as $g):?>
      ...
      <tr>
         ...
         <td align='center'>
			...
			<?php if ($g->idesoc==2): ?>
			<?php    echo $this->Html->link('Emitir Orden', ['action' => 'emitir', $g->id], array('confirm' => __('¿Está seguro que desea emitir la órden de compra {0}?', $g->correlativo), 'escape' => false, 'title' => 'Emitir')) ?>
			<?php endif; ?>
