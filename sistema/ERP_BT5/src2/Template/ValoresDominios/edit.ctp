...
<div class="col-md-8">
   <article class="widget widget__form">
      ...
      <div class="widget__content">
         ...
         <?=$this->Form->text("iddomi", ["size" => 10, "maxlength" => 20, "class" => "stacked-input upper", "id" => "iddomi", "placeholder" => "iddomi", 'placeholder' => 'iddomi']);?>
         <label for="descripcion" class="stacked-label"><i class="pe-7s-hammer" ></i></label>
         <?=$this->Form->text("descripcion", ["size" => 10, "maxlength" => 100, "class" => "stacked-input upper", "id" => "descripcion", "placeholder" => "descripcion", 'placeholder' => 'descripcion']);?>
