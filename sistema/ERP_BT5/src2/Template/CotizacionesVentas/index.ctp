...
<?php foreach ($cotizaciones as $cotizacion): ?>
   <tr>
      ...
      <td>
         ...
         <?php if ($cotizacion->idescv==1) echo $this->Html->link('<i class="pe-7s-note"></i>', ['action' => 'edit', $cotizacion->id],array('escape' => false,'data-toggle'=>"tooltip", 'title'=>"Editar")); ?>
         <?php if ($cotizacion->idescv==1) echo $this->Html->link('<i class="pe-7f-trash"></i>', ['action' => 'delete', $cotizacion->id], array('confirm' => __('¿Está seguro que desea eliminar el documento ID {0}?', $cotizacion->id), 'escape' => false, 'title' => 'Eliminar')); ?>
      </td>
   </tr>
   <tr class='spacer'></tr>
<?php endforeach; ?>
