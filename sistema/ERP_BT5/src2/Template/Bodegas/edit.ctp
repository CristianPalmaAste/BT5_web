   ...
   <article class="widget widget__form">
      <header class="widget__header">
         <div class="widget__title">
            <i class="pe-7s-file"></i><h3>Bodegas</h3>
         </div>
      </header>

      <div class="widget__content">
         <label for="id" class="stacked-label"><i data-toggle="tooltip" title="Correlativo Interno" class="pe-7s-note" ></i></label>
         ...
         <label for="nombre" class="stacked-label"><i data-toggle="tooltip" title="Nombre Bodega" class="pe-7s-note" ></i></label>
