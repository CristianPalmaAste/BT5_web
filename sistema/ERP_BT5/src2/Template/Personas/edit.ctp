...
<label for="idesci" class="stacked-label" style="clear:both;" data-toggle="tooltip" title="Estado Civil"><i class="pe-mi-love"></i></label>
         <?=$this->Form->select("idesci", $eciviles, ["class" => "stacked-input", 'style' => 'width: calc(100% - 65px);display: inline-block;height: 65px;text-color:rgb(255,255,255);background-color:rgba(0, 0, 0, 0.25);clear:right;']);?>
<label for="idsexo" class="stacked-label" style="clear:both;" data-toggle="tooltip" title="Género"><i class="pe-mi-sex"></i></label>
         <?=$this->Form->select("idsexo", $sexos, ["class" => "stacked-input", 'style' => 'width: calc(100% - 65px);display: inline-block;height: 65px;text-color:rgb(255,255,255);background-color:rgba(0, 0, 0, 0.25);clear:right;']);?>
<label for="idpais" class="stacked-label" style="clear:both;" data-toggle="tooltip" title="País"><i class="pe-mi-flag-1"></i></label>
         <?=$this->Form->select("idpais", $paises, ["class" => "stacked-input", 'style' => 'width: calc(100% - 65px);display: inline-block;height: 65px;text-color:rgb(255,255,255);background-color:rgba(0, 0, 0, 0.25);clear:right;']);?>
