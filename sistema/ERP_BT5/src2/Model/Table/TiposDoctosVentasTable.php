...
class TiposDoctosVentasTable extends Table
{
    public $_seq='tidv_seq';
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        ->requirePresence("codigooficial")
        ->notEmpty("codigooficial", "'Código oficial': debe ingresar un valor en este campo.")
        ;
    ...
    public function buildRules(RulesChecker $rules) {
        ...
        $rules->add($rules->isUnique(['descripcion','idpais'], 'Rut ya ha sido usado.'));
        $rules->add($rules->isUnique(['descripcioncorta','idpais'], 'Rut ya ha sido usado.'));
        $rules->add($rules->isUnique(['idpais','codigooficial'], 'Rut ya ha sido usado.'));
