...
class TiposRequisicionesTable extends Table
{
    public $_seq='tire_seq';
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        ->requirePresence("nrocotizacsminimo")
        ->notEmpty("nrocotizacsminimo", "'Nro.Míni.de Cotizs.': debe ingresar un valor en este campo.")
        ;
