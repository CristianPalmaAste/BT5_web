...
class DetallesMovtosBodegasTable extends Table
{
    public $_seq='demb_seq';
    ...
    public function buildRules(RulesChecker $rules) {
        ...
        $rules->add($rules->isUnique(['idmobo','correlativo'], 'Rut ya ha sido usado.'));
        $rules->add($rules->isUnique(['idmobo','idprod'], 'Rut ya ha sido usado.'));
