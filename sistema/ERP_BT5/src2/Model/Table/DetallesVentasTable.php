...
class DetallesVentasTable extends Table
{
    public $_seq='deve_seq';
    ...
    public function buildRules(RulesChecker $rules) {
        ...
        $rules->add($rules->isUnique(['idvent','correlativo'], 'Correlativo ya ha sido usado.'));
        $rules->add($rules->isUnique(['idvent','idprod','idserv'], 'Rut ya ha sido usado.'));
