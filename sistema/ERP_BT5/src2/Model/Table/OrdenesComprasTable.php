...
class OrdenesComprasTable extends Table
{
    public $_seq='orco_seq';
    ...
    {
        $validator
        ->requirePresence("idesoc")
        ->notEmpty("idesoc", "'Estado Soclicitud': debe ingresar un valor en este campo.")
        ;
    ...
    public function buildRules(RulesChecker $rules) {
        ...
        $rules->add($rules->isUnique(['idempr','correlativo'], 'Rut ya ha sido usado.'));
