...
class DetallesListasPreciosTable extends Table
{
    public $_seq='delp_seq';
    ...
    {
        $validator
        ->requirePresence("idlipr")
        ->notEmpty("idlipr", "'Tipo Producto': debe ingresar un valor en este campo.")
        ->requirePresence("idprod")
        ->notEmpty("idprod", "'Producto': debe ingresar un valor en este campo.")
        ->requirePresence("valorunitario")
        ->notEmpty("valorunitario", "'Precio': debe ingresar un valor en este campo.")
        ;
    ...
    public function buildRules(RulesChecker $rules) {
        ...
        $rules->add($rules->isUnique(['idlipr','idprod'], 'Rut ya ha sido usado.'));
