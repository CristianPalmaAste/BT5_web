<?= $this->Form->create($gre, ["id" => "frm", "method" => "post"]) ?> 
     ...
     <div class="widget__content">
		 ...
		 &nbsp;
         <?=$this->Form->text("fechanotaventa", ["size" => 10, "maxlength" => 10, "class" => "stacked-input upper", "id" => "fechanotaventa", "style" => "color:black;", "required" => true]);?>
		 </td>
		 </tr>
		 ...
		 <tr><td valign="middle">
         <label for="descripcionnotaventa" >Descripción Cotizado*</i></label>
		 </td>
		 <td>
		 ...
		 <tr><td>
         <label for="idesnv" >Estado</label></td>
		 <td>
         <?=$this->Form->hidden("idesnv");?>
		 <?=$this->Form->text("estado", ["size" => 10, "maxlength" => 10, "class" => "stacked-input upper", "id" => "estado", "style" => "color:black;", "value" => $estados_notas_vtas[1] , "readonly" => true]);?>
		 </td>
		 </tr>
		 ...
		 <td>
         <?=$this->Form->text("impuestos", ["size" => 10, "maxlength" => 12, "class" => "stacked-input upper", "id" => "impuestos", "style" => "color:black;text-align:right;", "readonly" => true, "value" => $gre->impuestos]);?>
		 </td>
		 </tr>
		 <tr><td>
...
//$("#nombre").focus();
   ...
   document.getElementById("rutclie").onblur=function() {
	  ...
	  $.ajax({
         url: "<?=$this->request->webroot?>NotasVentas/chkRutclie/"+idgrem.value+"/"+rut+"/"+dv,
   ...
   function oc_idprod(n) {
	  ...
	  $.ajax({
         url: "<?=$this->request->webroot?>NotasVentas/chkIdprod/"+idprod.value,
         success: function( result ) {
	     data = JSON.parse(result);
