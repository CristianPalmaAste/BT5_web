...
<div class="col-md-8">
   <article class="widget widget__form">
      ...
      <div class="widget__content">
         ...
         <?=$this->Form->text("username", ["size" => 100, "maxlength" => 100, "class" => "stacked-input upper", "id" => "username", "placeholder" => "Nombre Usuario", "readonly" => $gre->id!=""]);?>
         ...
         <?=$this->Form->select("idpers", $personas, ["class" => "stacked-input upper", "id" => "idpers", "placeholder" => "Persona", 'style' => 'width: calc(100% - 65px);display: inline-block;height: 65px;text-color:rgb(255,255,255);background-color:rgba(0, 0, 0, 0.25);clear:right;', 'required' => true, "disabled" => $gre->id!=""])?>
