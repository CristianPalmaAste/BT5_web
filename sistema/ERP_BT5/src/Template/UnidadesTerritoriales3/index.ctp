<?=$this->Form->create($gre, ["class" => "form-horizontal", 'url' => '/UnidadesTerritoriales3/index', 'novalidate' => true]);?>
<?php echo $this->BForm->formHeader( 'Comunas' ); ?>

<div class="col-md-4 text-center btn-vars__showcase">
   <div class="btn-group block">
      <a href="<?=$this->request->webroot?>UnidadesTerritoriales3/add" title='Nuevo registro' class="btn dark"><i class="pe-7s-plus"></i>&nbsp; Nuevo</a>
   </div>
</div>
<?php echo $this->BForm->initForm( 'Comunas',array(
        $this->Paginator->sort('idunt2', 'Provincia'),
...
?>
<!--<tr>
<td><?=$this->Form->text("idunt2", ["size" => 20, "maxlength" => 20, "class" => "stacked-input upper", "id" => "idunt2"]);?></td>
