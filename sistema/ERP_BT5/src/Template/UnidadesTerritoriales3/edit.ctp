...
<div class="col-md-8">
   <article class="widget widget__form">
      ...
      <div class="widget__content">
         ...
         <?=$this->Form->select("idunt2", $unidades_territoriales_2, ["class" => "stacked-input", "id" => "idunt2", 'placeholder' => 'Provincia*', 'style' => 'width: calc(100% - 65px);display: inline-block;height: 65px;text-color:rgb(255,255,255);background-color:rgba(0, 0, 0, 0.25);clear:right;']);?>
