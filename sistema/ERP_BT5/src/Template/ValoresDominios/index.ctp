<?=$this->Form->create($gre, ["class" => "form-horizontal", 'url' => '/ValoresDominios/index', 'novalidate' => true]);?>
<?php echo $this->BForm->formHeader( 'valores_dominios' ); ?>

<div class="col-md-4 text-center btn-vars__showcase">
   <div class="btn-group block">
      <a href="<?=$this->request->webroot?>ValoresDominios/add" title='Nuevo registro' class="btn dark"><i class="pe-7s-plus"></i>&nbsp; Nuevo</a>
   </div>
</div>
<?php echo $this->BForm->initForm( 'valores_dominios',array(
        $this->Paginator->sort('id', 'id'),
        $this->Paginator->sort('iddomi', 'iddomi'),
...
<td><?=$this->Form->text("iddomi", ["size" => 20, "maxlength" => 20, "class" => "stacked-input upper", "id" => "iddomi"]);?></td>
