...
?>
	  ...
	  <table style="border:1px solid white;" border="2" cellspacing="1" cellpadding="1">
		...
		<td><?=$this->Form->select("idprov", $proveedores, [ "id" => "idprov", 'placeholder' => 'Proveedor',  "style" => "color:black;", "readonly" => true]);?>
		</td>
		</tr>
         ...
         <tr><td><label for='idesoc' >Estado Órden*</label></td>
		     <td><?=$this->Form->text("idesoc", ["class" => "stacked-input", "id" => "idesoc", 'style' => 'color:black;', "readonly" => true, "value" => $estados_ordenes_compras[$gre->idesoc], 'size' => 85 ]);?>
</td></tr>
...
$("#nombre").focus();
   document.getElementById("idprov").disabled=true;
