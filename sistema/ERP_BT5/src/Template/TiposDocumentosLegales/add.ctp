...
<div class="col-md-8">
   <article class="widget widget__form">
      ...
      <div class="widget__content">
         ...
         <input type="text" class="stacked-input upper" name="descripcion" id="input-1" size="50" maxlength="100" placeholder="Descripción del Tipo de Documento">
         ...
         <input type="text" class="stacked-input upper" name="descripcioncorta" id="input-2" size="15" maxlength="15" placeholder="Descripción corta del Tipo de Documento">
