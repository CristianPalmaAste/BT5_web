...
<?php echo $this->BForm->formHeader( 'Autorización Asientos Contables' ); ?>

<div class="col-md-4 text-center btn-vars__showcase" style="display:none">
...
<?php foreach ($registros as $registro): ?>
   <tr>
      ...
      <td>
         <?= $this->Html->link('<i class="pe-7s-look"></i>', ['action' => 'view', $registro->id],array('escape' => false,'data-toggle'=>"tooltip", 'title'=>"Autorizar")) ?>
