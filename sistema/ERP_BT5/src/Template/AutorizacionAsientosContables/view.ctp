...
<?= $this->Form->create($gre, ["id" => "frm", "method" => "post"]) ?> 
     ...
     <div class="widget__content">
	     <h1>Autorización Asientos Contables</h1><br/>
		 ...
		 &nbsp;
         <?=$this->Form->text("fecha_asiento", ["size" => 10, "maxlength" => 10, "class" => "stacked-input", "placeholder" => "dd-mm-aaaa", "id" => "fecha_asiento", "style" => "color:black;", "readonly" => true, "type"=>"date"]);?>
		 &nbsp;
		 <label for="idtiac" >Tipo*</label>
		 &nbsp;
         <?=$this->Form->select("idtiac", $tipos_asientos_contables, ["class" => "stacked-input upper", "id" => "idtiac", "style" => "color:black;", "required" => true, "disabled" => true]);?>
		 </td>
		 </tr>
		 <tr><td><label for="glosa" >Glosa*</label></td>
		 </td>
		 <td>
         <?=$this->Form->text("glosa", ["size" => 60, "maxlength" => 100, "class" => "stacked-input upper", "id" => "glosa", "readonly" => true, "style" => "color:black;"]);?>
           </td>
		 </tr>
		 <tr>
		 <td>
		 ...
		 <?=$this->Form->select("reversible", $reversibles, ["class" => "stacked-input upper", "id" => "reversibles", "style" => "color:black;", "required" => true, "disabled" => true]);?>
		 </td>
		 </tr>
		 <tr>
		 <td>
         ...
         <tr><td colspan='2'>
		   ...
		   <td align="right">
           <!--<?= $this->Form->button(__('Autorizar'), ["style" => "color:black;"]) ?>-->
		 ...
		 <tr><td colspan='2' align="right"; style="padding:5px"><?php echo $this->Html->link('Autorizar Asiento', ['action' => 'autorizar', $gre->id], array('confirm' => __('¿Está seguro de autorizar el asiento número {0}?', $gre->numero_asiento), 'escape' => false, 'title' => 'Autorizar', 'style'=>'color:white;border:1px solid white;')); ?>
		     </td>
		 </tr>
         </table>
...
<a href="<?=$this->request->webroot?>AutorizacionAsientosContables/index" class="btn dark inverse">Volver</a>
</div> 
</div>
