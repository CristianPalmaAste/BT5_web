   ...
   <article class="widget widget__form">
      <header class="widget__header">
         <div class="widget__title">
            <i class="pe-7s-file"></i><h3>Centros de Costo</h3>
         </div>
      </header>
      ...
      <div class="widget__content">
         ...
         <label for="nombre" class="stacked-label"><i data-toggle="tooltip" title="Nombre del Centro de Costo" class="pe-7s-note" ></i></label>
