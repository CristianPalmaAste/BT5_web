...
<div class="col-md-8">
   <article class="widget widget__form">
      ...
      <div class="widget__content">
         ...
         <label for="nombrecorto" class="stacked-label  data-toggle="tooltip" title="Nombre Corto""><i class="pe-7s-note" ></i></label>
         ...
         <label for="nombrelargo" class="stacked-label"  data-toggle="tooltip" title="Nombre del Parámetro"><i class="pe-7s-note" ></i></label>
         ...
         <label for="descripcion" class="stacked-label"  data-toggle="tooltip" title="Descripción del Parámetro"><i class="pe-7s-note" ></i></label>
         ...
         <label for="valor" class="stacked-label"  data-toggle="tooltip" title="Valor del Parámetro"><i class="pe-7s-note" ></i></label>
