...
<?php foreach($registros as $g):?>
      ...
      <tr>
         ...
         <td align='center'>
            ...
            <?= $this->Html->link('<i class="pe-7f-trash"></i>', ['action' => 'delete', $g->id], array('confirm' => __('¿Está seguro que desea eliminar la Sub.Familia "{0}"?', $g->sub_familia), 'escape' => false, 'title' => 'Eliminar')) ?>
         </td>
     </tr>
     <tr class='spacer'></tr>
<?php endforeach; ?>
