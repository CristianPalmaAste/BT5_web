...
?>
	  ...
	  <h1>Requisiciones Autorizador</h1><br/>
	  ...
	  <table style="border:1px solid white;" border="2" cellspacing="1" cellpadding="1">
        ...
        <tr><td><label for='idtire' >Tipo de Requisición*</label></td>
		<td><?=$this->Form->text("idtire", ["class" => "stacked-input", "id" => "idtire", 'placeholder' => 'Tipo de Requisición*', 'style' => 'color:black;', 'readonly' => true, 'value' => $tipos_requisiciones[$gre->idtire]]);?></td></tr>

         <tr><td><label for='idusuasolicitareq' >Usuario Solicitante*</label></td>
		 <td><?=$this->Form->text("idusuasolicitareq", ["class" => "stacked-input upper", "id" => "idusuasolicitareq", 'placeholder' => 'Usuario Solicitante*', 'style' => 'color:black;', 'readonly' => true, 'value' => $usuarios[$gre->idusuasolicitareq] ]);?></td></tr>
		 <tr><td><label for="idgere" >Gerencia</label></td>
		 <td>
         <?=$this->Form->text("idgere", [ "id" => "idgere", 'placeholder' => 'Gerencia', "style" => "color:black;", "readonly" => true, "value" => $gerencias[$gre->idgere]]);?>
		 &nbsp; <label>Proyecto</label>
		 &nbsp;
         <?=$this->Form->text("idproy", [ "id" => "idproy", 'placeholder' => 'Proyecto', "style" => "color:black;", "readonly" => true, "value" => $proyectos[$gre->idproy]]);?>
		 </td>
		 </tr>
		 <tr><td>
         <label for="idline" >Línea de negocios</i></label></td>
		 <td>
         <?=$this->Form->text("idline", [ "id" => "idline", 'placeholder' => 'Línea de negocios', "style" => "color:black;", "readonly" => true, "value" => $lineas_negocios[$gre->idline]]);?>
		 &nbsp;
         <label for="idceco" >Centro de Costo</label>&nbsp;
         <?=$this->Form->text("idceco", [ "id" => "idceco", 'placeholder' => 'Centro de Costo',"style" => "color:black;", "readonly" => true, "value" => $centros_costos[$gre->idceco]]);?>
		 </td>
		 </tr>
		 <tr><td>
         <label for="idtare" >Tarea</i></label></td>
		 <td>
         <?=$this->Form->text("idtare", [ "id" => "idtare", 'placeholder' => 'Tarea',  "style" => "color:black;", "readonly" => true, "value" => $tareas[$gre->idtare]]);?>
		 </td>
		 </tr>
         <tr><td><label for='idereq' >Estado Requisición*</label></td>
		     <td><?=$this->Form->text("idereq", ["class" => "stacked-input", "id" => "idereq", 'placeholder' => 'Estado Requisición', 'style' => 'color:black;', "readonly" => true, "value" => $estados_requisiciones[$gre->idereq], "size" => 85 ]);?>
</td></tr>
<tr><td><label for='idereq' >Razón Rechazo</label></td><td><?=$this->Form->text("razonrechazo", ["class" => "stacked-input", "id" => "idereq", 'style' => 'color:black;', 'size' => 85,'readonly' => true]);?>
</td></tr>
...
<a href="<?=$this->request->webroot?>RequisicionesAutorizador/index" class="btn dark inverse">Volver</a>
</div>
</div>
