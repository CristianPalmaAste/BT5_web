<?=$this->Form->create($gre, ["class" => "form-horizontal", 'url' => '/FamiliasProductos/index', 'novalidate' => true]);?>
<?php echo $this->BForm->formHeader( 'Familias de Productos' ); ?>

<div class="col-md-4 text-center btn-vars__showcase">
   <div class="btn-group block">
      <a href="<?=$this->request->webroot?>FamiliasProductos/add" title='Nuevo registro' class="btn dark"><i class="pe-7s-plus"></i>&nbsp; Nuevo</a>
   </div>
</div>
<?php echo $this->BForm->initForm( 'Familias de Productos',array(
...
?>
<!--<tr>
<td><?=$this->Form->text("cod_familia", ["size" => 2, "maxlength" => 2, "class" => "stacked-input upper", "id" => "cod_familia"]);?></td>
