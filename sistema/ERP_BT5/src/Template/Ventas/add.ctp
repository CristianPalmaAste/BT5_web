<?= $this->Form->create($gre, ["id" => "frm", "method" => "post"]) ?> 
     ...
     <div class="widget__content">
		 ...
		 &nbsp;
         <?=$this->Form->text("fechaventa", ["size" => 10, "maxlength" => 10, "class" => "stacked-input upper", "id" => "fechaventa", "style" => "color:black;", "required" => true]);?>
		 </td>
		 </tr>
		 ...
		 <tr><td valign="middle">
         <label for="descripcionventa" >Descripción Cotizado*</i></label>
		 </td>
		 <td>
		 ...
		 <tr><td>
         <label for="idesve" >Estado</label></td>
		 <td>
         <?=$this->Form->hidden("idesve");?>
		 <?=$this->Form->text("estado", ["size" => 10, "maxlength" => 10, "class" => "stacked-input upper", "id" => "estado", "style" => "color:black;", "value" => $estados_ventas[1] , "readonly" => true]);?>
		 </td>
		 </tr>
