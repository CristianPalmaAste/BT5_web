<?= $this->Form->create($gre, ["id" => "frm", "method" => "post"]) ?> 
     ...
     <div class="widget__content">
		 ...
		 <?=$this->Form->select("razclie", $clientes, ["class" => "stacked-input upper", "id" => "razclie", "style" => "color:black;"]);?>
		 </td>
		 </tr>
		 ...
		 &nbsp;
         <?=$this->Form->hidden("idescv");?>
		 <?=$this->Form->text("estado", ["size" => 10, "maxlength" => 10, "class" => "stacked-input upper", "id" => "estado", "style" => "color:black;", "value" => $estados_cotizaciones_vtas[1] , "readonly" => true]);?>
		 </td>
		 </tr>
...
//$("#nombre").focus();
   ...
   document.getElementById("rutclie").onblur=function() {	 
      lista = document.getElementById("razclie")
      for (i=1; i < lista.options.length; i++) {
		  //alert(lista.options[i].value);
		  l = lista.options[i].value.split("|");
		  
		  if (l[0]==this.value) {
			 document.getElementById("idclie").value=l[1];
			 lista.value=lista.options[i].value;
		     return;  
		  }
	  }
...
//	  }
//	  
//	  razclie.value=rutclie.value;
//
//	  alert(razclie.length);
//	  
//	  for(i=0; i < razclie.options.length; i--) {
//		 alert(razclie.options.item[i].value+" - "+rut+dv);
//		 
//		 if (razclie.options.item[i].value==rut+dv) {
//			razclie.value=rut+dv;
//			return;
//		 }
//	  }
//	  
...
//     });
   ...
   function ob_porcentajedescuento(n) {
	  ...
	  if (v.value*1.0 > 100) v.value=100;
   ...
   function ob_montodescuento(n) {
	  ...
	  if (precio.value > 0)
	     porc.value = Math.round(100.0*v.value/precio.value, 2);
	  else {
		 porc.value=0;
		 v.value   =0;
	  }
   ...
   document.getElementById("razclie").onchange = function(){
	   if (this.value=="") {
		  document.getElementById("rutclie").value="";
		  document.getElementById("razclie").value="";
		  document.getElementById("idclie").value="";
	   }
	   else {
		  s = this.value;
		  l = s.split("|");
		  
		  document.getElementById("rutclie").value=l[0];
		  document.getElementById("idclie").value=l[1];
	   }
    }		
</script>
