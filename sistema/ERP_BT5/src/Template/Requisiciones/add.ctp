...
<td><?=$this->Form->text("correlativo", ["size" => 10, "maxlength" => 20, "class" => "stacked-input upper", "id" => "correlativo", 'placeholder' => 'Correlativo*', 'style' => 'color:black;', 'readonly' => true]);?></td></tr>
...
<tr><td colspan='2' align='right'><button type='submit' class='ninguna'>Grabar</button></td></tr>
</table>
