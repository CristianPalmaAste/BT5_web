...
<div class="row" style="padding-bottom:5px;" style="padding-bottom:5px;">
   <div class="col-sm-3">
      <label class="control-label" for="idmone">idmone:</label>
   </div>
   <div class="col-sm-6">
        <?=$this->Form->text("idmone", ["class" => "form-control", "size" => 50, "maxlength" => 100]);?>
   </div>
</div>
<div class="row" style="padding-bottom:5px;" style="padding-bottom:5px;">
   <div class="col-sm-3">
   ...
   <div class="col-sm-6">
        <?=$this->Form->text("nacionalidad", ["class" => "form-control", "size" => 50, "maxlength" => 100]);?>
   </div>
</div>
...
<div class="row" style="padding-bottom:5px;">
   ...
   <div class="col-sm-2">
      <?=$this->Html->link("Listado", "/Paises", ["class" => "btn btn-default"]);?>
   </div>
</div>
