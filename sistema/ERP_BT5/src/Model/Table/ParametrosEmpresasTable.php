...
class ParametrosEmpresasTable extends Table
{
    public $_seq='paem_seq';
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        ->notEmpty("nombrecorto", "'Nombre Corto': debe ingresar un valor en este campo.")
        ->requirePresence("nombrelargo")
        ->notEmpty("nombrelargo", "'Nombre Largo': debe ingresar un valor en este campo.")
    ...
    public function buildRules(RulesChecker $rules) {
        ...
        $rules->add($rules->isUnique(['idempr','nombrecorto'], 'Rut ya ha sido usado.'));
        $rules->add($rules->isUnique(['idempr','nombrelargo'], 'Rut ya ha sido usado.'));
