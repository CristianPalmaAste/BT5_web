...
class ClientesTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        ->notEmpty("idticl", "'Tipo cliente': debe ingresar un valor en este campo.")
    ...
    public function beforeSave($event, $entity, $options){              
	   ...
	   if ($entity->idticl!=1) {
		  $entity->primernombre    = null;
		  $entity->segundonombre   = null;
		  $entity->apellidopaterno = null;
		  $entity->apellidomaterno = null;
	   }
	   else {
		  $entity->razonsocial    = null;
		  $entity->nombrefantasia = null; 
	   }
