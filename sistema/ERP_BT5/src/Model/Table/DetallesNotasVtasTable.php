...
class DetallesNotasVtasTable extends Table
{
    public $_seq='denv_seq';
    ...
    {
        $validator
        ->requirePresence("idnove")
        ->notEmpty("idnove", "'idnove': debe ingresar un valor en este campo.")
    ...
    public function buildRules(RulesChecker $rules) {
        ...
        $rules->add($rules->isUnique(['idnove','correlativo'], 'Rut ya ha sido usado.'));
        $rules->add($rules->isUnique(['idnove','idprod','idserv'], 'Producto ya ha sido utilizado.'));
