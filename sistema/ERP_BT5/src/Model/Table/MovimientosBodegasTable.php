...
class MovimientosBodegasTable extends Table
{
    public $_seq='';
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        ->requirePresence("idtimb")
        ->notEmpty("idtimb", "'Tipo de Movimiento': debe ingresar un valor en este campo.")
        ->requirePresence("fechamovto")
        ->notEmpty("fechamovto", "'Fecha Movto.': debe ingresar un valor en este campo.")
    ...
    public function buildRules(RulesChecker $rules) {
        ...
        $rules->add($rules->isUnique(['idbode','correlativo'], 'Rut ya ha sido usado.'));
