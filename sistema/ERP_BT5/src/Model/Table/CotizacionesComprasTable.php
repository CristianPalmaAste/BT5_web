...
class CotizacionesComprasTable extends Table
{
    public $_seq='coco_seq';
    ...
    {
        $validator
        ->requirePresence("idprov")
        ->notEmpty("idprov", "'Proveedor': debe ingresar un valor en este campo.")
        ;
    ...
    public function buildRules(RulesChecker $rules) {
        $rules->add($rules->isUnique(['idrequ','idorco','idprov'], 'Proveedor ya ha sido usado.'));
