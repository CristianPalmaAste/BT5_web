...
class PaginatorHelper extends Helper
{
    ...
    protected $_defaultConfig = [
        ...
        'templates' => [
            ...
            'sort' => '<a style="color:#FFFFFF;text-decoration: underline;font-size:18px;" href="{{url}}">{{text}}</a>',
            'sortAsc' => '<a style="color:#FFFFFF;text-decoration: underline;font-size:18px;" class="asc" href="{{url}}">{{text}}</a>',
            'sortDesc' => '<a style="color:#FFFFFF;text-decoration: underline;font-size:18px;" class="desc" href="{{url}}">{{text}}</a>',
