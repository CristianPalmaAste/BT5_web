<?=$this->Form->create($gre, ["class" => "form-horizontal", 'url' => '/EstadosRegistros/index', 'novalidate' => true]);?>
...
<div class="col-md-4 text-center btn-vars__showcase">
   <div class="btn-group block">
      <a href="<?=$this->request->webroot?>EstadosRegistros/add" title='Nuevo registro' class="btn dark"><i class="pe-7s-plus"></i>&nbsp; Nuevo</a>
   </div>
</div>
