<?=$this->Form->create($gre, ["class" => "form-horizontal", 'url' => '/CentrosCostos/index', 'novalidate' => true]);?>
<?php echo $this->BForm->formHeader( 'Mantención de Centros de Costo' ); ?>

<div class="col-md-4 text-center btn-vars__showcase">
   <div class="btn-group block">
      <a href="<?=$this->request->webroot?>CentrosCostos/add" title='Nuevo registro' class="btn dark"><i class="pe-7s-plus"></i>&nbsp; Nuevo</a>
   </div>
</div>
<?php echo $this->BForm->initForm( 'Mantención de Centros de Costo',array(
...
<td><?=$this->Form->text("idempr", ["size" => 5, "maxlength" => 5, "class" => "stacked-input upper", "id" => "idempr"]);?></td>
