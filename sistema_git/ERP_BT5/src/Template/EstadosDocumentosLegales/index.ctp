...
<?php foreach ($estadosDocumentosLegales as $estadosDocumentosLegale): ?>
   ...
   <td>
         ...
         <?= $this->Form->postLink('<i class="pe-7f-trash"></i>',
               ['action' => 'delete',$estadosDocumentosLegale->id,],
               ['confirm' => __('¿Está seguro que desea eliminar el estado de documento {0}?', $estadosDocumentosLegale->descripcion),'data-toggle'=>'tooltip','title'=>'Eliminar','escape' => false]
            )
         ?>
      </td>
   </tr>
