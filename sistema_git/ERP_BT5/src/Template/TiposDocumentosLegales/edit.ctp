...
<div class="col-md-8">
   <article class="widget widget__form">
      ...
      <div class="widget__content">
         ...
         <input type="text" class="stacked-input upper" name="descripcion" id="input-1" placeholder="Descripción del Tipo de Documento" value="<?=$tiposDocumentosLegale->descripcion ?>">
         ...
         <input type="text" class="stacked-input upper" name="descripcioncorta" id="input-2" placeholder="Descripción corta del Tipo de Documento" value="<?=$tiposDocumentosLegale->descripcioncorta ?>">
