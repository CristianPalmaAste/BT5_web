...
<?php foreach ($tiposDocumentosLegales as $tiposDocumentosLegale): ?>
   ...
   <td>
         ...
         <?= $this->Form->postLink('<i class="pe-7f-trash"></i>',
               ['action' => 'delete',$tiposDocumentosLegale->id,],
               ['confirm' => __('¿Está seguro que desea eliminar el tipo de documento {0}?', $tiposDocumentosLegale->descripcion),'data-toggle'=>'tooltip','title'=>'Eliminar','escape' => false]
            )
         ?>
      </td>
   </tr>
