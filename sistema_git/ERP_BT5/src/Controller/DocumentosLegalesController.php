   ...
   */
   public function edit($id = null){
    ...
    public function delete($id = null)
    {
        ...
        $documentosLegale = $this->DocumentosLegales->get($id);
        if ($this->DocumentosLegales->delete($documentosLegale)) {
            $this->Flash->success(__('The documentos legale has been deleted.'));
        } else {
            $this->Flash->error(__('The documentos legale could not be deleted. Please, try again.'));
        }
